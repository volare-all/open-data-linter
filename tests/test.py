...
class TestCsvLinter(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.nb01h0013 = gen_csv_linter("tests/samples/nb01h0013.csv")
        cls.nb01h0013_sjis = gen_csv_linter("tests/samples/nb01h0013_sjis.csv")
        cls.nb01h0013_cp932 = gen_csv_linter("tests/samples/nb01h0013_cp932.csv")
        cls.perfect = gen_csv_linter("tests/samples/perfect.csv")
        cls.text = gen_csv_linter("tests/samples/text.txt")
        cls.check_1_2 = gen_csv_linter("tests/samples/check_1_2.csv")
        cls.classify_sample = gen_csv_linter("tests/samples/classify_sample.csv")

    def test_empty_header(self):
        linter = gen_csv_linter("tests/samples/all_num.csv")
    ...
    def test_check_1_3(self):
        ...
        linter = gen_csv_linter("tests/samples/check_1_3.csv")
    ...
    def test_check_1_5(self):
        ...
        linter = gen_csv_linter("tests/samples/check_1_5.csv")
    ...
    def test_check_1_6(self):
        ...
        linter = gen_csv_linter("tests/samples/check_1_6.csv")
    ...
    def test_check_1_11(self):
        ...
        linter = gen_csv_linter("tests/samples/check_1_11.csv")
    ...
    def test_check_1_12(self):
        ...
        linter = gen_csv_linter("tests/samples/check_1_12.csv")
    ...
    def test_check_1_13(self):
        self.assertValidLintResult(self.perfect.check_1_12())
        linter = gen_csv_linter("tests/samples/check_1_13.csv")
    ...
    def test_check_2_1(self):
        ...
        linter = gen_csv_linter("tests/samples/check_2_1.csv")
